...
+ (NSData *) readOneData: (ESPSocketClient*) socketClient
{
 ...
 */
+ (int) readHttpHeader: (ESPSocketClient*) socketClient IntoBuffer: (NSMutableData *) buffer Offset: (int) byteOffset
{
    int count = 0;
    NSData *last = nil;
 ...
 */
+ (void) readData: (ESPSocketClient*) socketClient IntoBuffer: (NSMutableData *)buffer Offset: (int) bufferOffset Count: (int) bufferCount
{
