...
- (instancetype) initWithBssid:(NSString *)bssid RootInetAddress:(NSString *)rootInetAddress ParentBssid:(NSString *)parentBssid DeviceType:(ESPDeviceType *)deviceType ChildrenCount:(int)childrenCount;
...
+ (MeshDevice *) queryMeshDevice:(NSString *)inetAddr Bssid:(NSString *)bssid
{
    ...
    @try {
        ...
        currentDevice = [[MeshDevice alloc]initWithBssid:bssid RootInetAddress:inetAddr ParentBssid:currentParentBssid DeviceType:currentDeviceType ChildrenCount:currentCount];
        ...
        for (NSDictionary *jsonChild in jsonArrayChildren) {
            ...
            // build child device
            MeshDevice *childDevice = [[MeshDevice alloc]initWithBssid:childBssid RootInetAddress:inetAddr ParentBssid:currentBssid DeviceType:childDeviceType ChildrenCount:childCount];
